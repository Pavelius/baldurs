...
BSDATA(feati) = {{"Alertness", "Бдительность"},
...
{"Endurance", "Выносливость", {}, {}, 0, 0, "Вы выработали поразительную черту, благодаря чему вы очень выносливы.", "В любой ситуации, где необходима проверка физического напряжения, требуемого на длительный промежуток времени, у вас +4 бонус к проверке (обморожение, голод, жажда, плавание и т.д.). Вы также можете без усталости спать в легких или средних доспехах, что разрешает вам оставаться готовым к бою, при нападении на привале.", "Персонаж без этой черты, который спит в средних и более тяжелых доспехах при внезапном бою на привале автоматически не готов к бою."},
...
{"Focus shoting", "Фокус на стрельбе", {0}, {ProficiencySimple}, 1},
{"Focus swords", "Фокус на мечах", {0}, {ProficiencyShortsword}, 1},
...
{"Immunity to Sleep spell", "Иммунитет ко сну", {}, {}, 0, 0, "Иммунитет к заклинанию [Сон] и всем другим подобным заклинаниям, которые могут усыпить."},
{"Find secrets", "Находит секреты", {}, {}, 0, 0, "Находятсь в 4 метрах от секретной двери делается бросок поиска, как будто активно ее ищет."},
