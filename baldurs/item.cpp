...
{"Heavy crossbow", "Тяжелый арбалет", {"IXBOWH01", "GXBOW01", res::WQSBW}, QuickWeapon, {ProficiencyHeavyCrossbow, FocusShooting}, {}, {{Pierce, 1, 10}}},
{"Sling", "Праща", {"ISLNGB1", "GSLNG01", res::WQSSL}, QuickWeapon, {ProficiencySimple}, {}, {{Bludgeon, 1, 4}}},

{"Battle axe", "Боевой топор", {"IAX1HB2", "GAX1H01", res::WQSAX}, QuickWeapon, {ProficiencyAxe, FocusAxes}, {}, {{Slashing, 1, 8}}, 0, 0, 0, {}, "Боевой топор, наиболее распространённое оружие ближнего боя среди карликов."},
{"Dagger", "Кинжал", {"IDAGGB1", "GDAGG01", res::WQSDD}, QuickOffhand, {ProficiencyDagger, FocusDaggers}, {}, {{Pierce, 1, 4}}},
{"Greataxe", "Секира", {"IAX2HB1", "GHALB01", res::WQSHB}, QuickWeapon, {ProficiencyGreatweapon, FocusAxes}, {}, {{Slashing, 1, 12}}, 0, 0, 0, {}, "Этот большой, тяжёлый топор, любимое оружие у варваров, или любого персонажа, желающего обладать способностью наносить непревзойдённые повреждения."},
...
{"Scimitar", "Сабля", {"ISWDCB2", "GSW1H07", res::WQSSS}, QuickOffhand, {ProficiencyScimitar, FocusSwords}, {}, {{Slashing, 1, 6}}, 0, 0, 0, {}, "Изогнутость лезвия этого оружия, делает кромку этого оружия очень острой."},
{"Longsword", "Длинный меч", {"ISWDLB1", "GSW1H01", res::WQSS1}, QuickWeapon, {ProficiencyLongsword, FocusSwords}, {}, {{Slashing, 1, 8}}, 0, 0, 0, {}, "Это классическое, прямое лезвие. Оружие, воплощающее в себе рыцарство и доблесть. Оно излюбленное оружие паладинов."},
{"Shortsword", "Короткий меч", {"ISWDSB1", "GSW1H07", res::WQSSS}, QuickOffhand, {ProficiencyShortsword, FocusSwords}, {}, {{Slashing, 1, 6}}},
{"Two handed sword", "Двуручный меч", {"ISWDTB1", "GSW2H01", res::WQSS2}, QuickWeapon, {ProficiencyGreatweapon, FocusSwords}, {}, {{Slashing, 2, 6}}},
{"Rapier", "Рапира", {"ISWDSB1", "GSW1H07", res::WQSSS}, QuickWeapon, {ProficiencyShortsword, FocusDaggers}, {}, {{Pierce, 1, 6}}},
{"Short bow", "Короткий лук", {"IBOWSB1", "GBOW01", res::WQSBW, res::ARARROW}, QuickWeapon, {ProficiencyShortbow, FocusShooting}, {}, {{Pierce, 1, 6}}},
{"Long bow", "Длинный лук", {"IBOWLB1", "GBOW01", res::WQSBW, res::ARARROW}, QuickWeapon, {ProficiencyLongbow, FocusShooting}, {}, {{Pierce, 1, 8}}},
