...
public:
	...
	void				addv(const char* format, const char* format_param, const char* prefix, const char* suffix);
	...
	void				sep(const char* first_time, const char* start, const char* separator = ", ");
