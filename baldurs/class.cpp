...
{LawfulGood, LawfulNeutral, LawfulEvil}, "Дикий, сильный воин, использующий свою ярость и инстинкты для победы над врагами."
},
{"Bard", "Бард", 6, 4, 0, Charisma, bard_skills, simple_weapons_sword, medium_armor_and_shield,
{LawfulGood, LawfulEvil}, "Актер, чья музыка равносильна магии - путешественник, сказочник, исполнитель баллад и хороший торговец."
},
{"Cleric", "Клерик", 8, 2, cleric_spells, Wisdow, cleric_skills, simple_weapons, all_armor,
{}, "Мастер божественной магии, а также неплохой воин."},
{"Druid", "Друид", 6, 4, cleric_spells, Wisdow, druid_skills, druid_weapons, medium_armor_and_shield,
{LawfulGood, ChaoticGood, LawfulNeutral, LawfulEvil, ChaoticEvil}, "Тот, кто способен использовать энергию живого мира, чтобы применять заклинания и обладать таинственными магическими силами."},
...
{}, "Рыцарь справедливости и уничтожитель зла, защищенный и усиленный владением божественных сил."},
{"Ranger", "Следопыт", 10, 4, 0, Wisdow, ranger_skills, martial_weapons, light_armor_and_shield,
{}, "Хитрый, ловкий, умелый воин дикой лесной местности."},
...
{}, "Заклинатель с врожденными способностями к магии."},
